...
$(window).resize(function(){
    if ($(window).width() <= 776) {
        ...
        $("div.related:first ul li:not(.right):first a").text("PVRVFrame User Manual  documentation");
        $("div.related:last  ul li:not(.right):first a").text("PVRVFrame User Manual  documentation");
    }
});